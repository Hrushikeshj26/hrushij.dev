...
function Navbar() {
  ...
  return (
    <div className='fixed w-full h-20 bg-black flex justify-between items-center px-6 md:px-16 text-white z-50 shadow-md'>
        ...
        <ul className='hidden md:flex gap-10 font-medium text-xl'>
            <li>
              <Link to="/" className="cursor-pointer hover:text-blue-400 transition-colors">
                Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="cursor-pointer hover:text-blue-400 transition-colors">
                About
              </Link>
            </li>
            <li>
